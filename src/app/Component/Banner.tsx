    ...
    <div className="mx-auto w-full max-w-7xl px-7 my-7">
      <div className="bg-[#222630] py-10 flex justify-around items-center rounded-2xl">
        ...
        <div className="space-y-4">
          <p className="text-[#C2F800] font-inter font-bold text-[11px]">
            WORKOUT LIBRARY
          </p>

          <h1 className="text-white font-bold font-oswald text-6xl">
          ...
          <button className="btn text-black font-bold font-inter bg-[#C2F800]">
            BROWSE WORKOUTS
          </button>
        </div>
